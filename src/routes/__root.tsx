...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BrightLine Cleaning" },
      ...
      { name: "twitter:title", content: "BrightLine Cleaning" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/7492ffcc-640d-40e6-9b3a-3b2dfba46bca" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/7492ffcc-640d-40e6-9b3a-3b2dfba46bca" },
    ],
    links: [
